...
{#if hidden}
    {#if userIsSelected()}
        <div class="w-16 h-16 text-indigo-500 cursor-pointer drag:cursor-pointer flex flex-col items-center" on:dragstart={() => dragHuman(id, event)} draggable="true" id="{id}">
